...
public class InventoryContract {
    ...
    public static final String CONTENT_AUTHORITY = "com.inventory.ragab.InventoryApp";
    ...
    public final static class InventoryEntry implements BaseColumns {
        ...
        public final static int SUPPLIER_ALI = 2;
        public final static int SUPPLIER_OBEIKAN = 3;

        // Valid to SupplierName
        public static boolean isValidSupplierName(int suppliername) {
            return suppliername != SUPPLIER_UNKNOWN && suppliername != SUPPLIER_AMAZON && suppliername != SUPPLIER_ALI && suppliername != SUPPLIER_OBEIKAN;
        }
